...
public class File
    ...
    private Path path;
    static private char separatorChar = '/';
    static private String separator = "/";
    static private char pathSeparatorChar = ':';
    static private String pathSeparator = ":";
     ...
     * @throws IOException 
     */
    private File(String pathname, int prefixLength) throws IOException {
    	init();
     ...
     * @throws IOException 
     */
    private File(String child, File parent) throws IOException {
        assert parent.path != null;
        assert (!parent.path.equals(""));
        init();
        this.path = new Path(fs.resolve(parent.path.toString(), child));
    ...
    public File(String pathname) {
        ...
        this.path = new Path(fs.normalize(pathname));
     //   this.prefixLength = fs.prefixLength(this.path);
    }
    
    /**
     * This is a static class containing a copy of the UnixFileSystem and
     * its associated functions I moved these here because HadoopFS does not have 
     * an implementation of this method. XXXProbably Moved.XXX
     */
    ...
    public static class fs{
    	...
    	public static String normalize(String pathname) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                if ((prevChar == '/') && (c == '/'))
                    return fs.normalize(pathname, n, i - 1);
                prevChar = c;
            }
            if (prevChar == '/') return fs.normalize(pathname, n, n - 1);
            return pathname;
        }
    ...
    public File(String parent, String child) {
        ...
        if (parent != null) {
            if (parent.equals("")) {
                this.path = new Path(fs.resolve(hdfs.getWorkingDirectory().toString(),
                                       fs.normalize(child)));
            } else {
                this.path = new Path(fs.resolve(fs.normalize(parent),
                                       fs.normalize(child)));
            }
        } else {
            this.path = new Path(fs.normalize(child));
        }
       // this.prefixLength = fs.prefixLength(this.path);
    }
    ...
    public File(File parent, String child) {
        ...
        if (parent != null) {
            if (parent.path.equals("")) {
                ...
                this.path = new Path(fs.resolve(parent.path.toString(),
                                       fs.normalize(child)));
            }
        } else {
            this.path = new Path(fs.normalize(child));
...
*/
    ...
    public String getName() {
        int index = path.toString().lastIndexOf(separatorChar);
        if (index < prefixLength) return path.toString().substring(prefixLength);
        return path.toString().substring(index + 1);
    }
    ...
    public String getParent() {
        ...
        if (index < prefixLength) {
            if ((prefixLength > 0) && (path.toString().length() > prefixLength))
                return path.toString().substring(0, prefixLength);
            return null;
        }
...
*/
    ...
    public boolean createNewFile() throws IOException {
       return hdfs.createNewFile(path);
    }
...
*/
    ...
    public boolean renameTo(File dest) throws IOException {
    	return hdfs.rename(path, dest.path);
    }
...
*/
    ...
    public int compareTo(File pathname) {
        return path.toString().compareTo(pathname.toString());
    }
     ...
     */
    public int hashCode() {
        return path.toString().hashCode() ^ 1234321;
    }
